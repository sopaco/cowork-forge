...
Cowork Forge 支持导入**任意现有项目**——即使不是用 Cowork Forge 创建的项目。导入功能使用 AI 逆向分析您的项目并生成完整的文档：
...
1. **项目扫描**：分析目录结构、配置文件和依赖项
2. **技术栈检测**：识别框架、语言和工具
3. **文档提取**：读取 README、文档目录和关键源文件
4. **AI 智能生成**：使用 LLM 将信息综合成结构化的文档
...
- <strong>Legacy Project Analyzer Agent</strong>: 分析现有项目并逆向生成文档（idea.md、prd.md、design.md、plan.md）
...
- <strong>现有项目导入：</strong> 导入任意现有项目，使用 AI 逆向分析代码结构和现有文档，生成完整的文档（idea.md、prd.md、design.md、plan.md）。

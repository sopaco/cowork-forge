...
- You MUST call `save_check_report(content)` at the END of your work
- Without calling this tool, the Check stage CANNOT complete
- Your work will be LOST if you don't save the report
- Example: `save_check_report("# Check Report\n\n## Results\n...")`
...
7. **MANDATORY**: ALWAYS call save_check_report(content) at the end to save the check report - this is REQUIRED to complete the check stage
"##
;

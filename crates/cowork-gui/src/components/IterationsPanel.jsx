...
const IterationsPanel = ({
  ...
  const [newIterationInheritance, setNewIterationInheritance] =
    useState("partial");
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          {iterations.map((iteration) => (
            <Card
              ...
              hoverable
              className={
                selectedIterationId === iteration.id ? "selected-iteration" : ""
              }
              style={{
                border:
                ...
                <div style={{ flex: 1 }}>
                  ...
                  {iteration.base_iteration_id && (
                    ...
                    >
                      ...
                      Based on iteration:{" "}
                      {iteration.base_iteration_id.substring(0, 12)}...
                  ...
                  <div style={{ marginTop: "12px" }}>
                    ...
                    <Progress
                      ...
                      size="small"
                      status={
                        iteration.status === "Failed" ? "exception" : "active"
                      }
                    />
                  </div>
                  ...
                  >
                    {STAGES.map((stage) => {
                      ...
                      const currentStageIndex = STAGES.findIndex(
                        (s) => s.key === iteration.current_stage,
                      );
          ...
          {iterations.length > 0 && (
            <>
              <Form.Item label="Base Iteration (Optional)">
                ...
                <div
                  style={{ marginTop: "4px", fontSize: "12px", color: "#888" }}
                >
          ...
          <div>
            ...
            <div style={{ marginBottom: "16px" }}>
              ...
              >
                {STAGES.map((stage) => {
                  const currentStageIndex = STAGES.findIndex(
                    (s) => s.key === selectedIteration.current_stage,
                  );
                  const stageIndex = STAGES.findIndex(
                    (s) => s.key === stage.key,
                  );
                  ...
                  const isCurrent =
                    selectedIteration.current_stage === stage.key;

    ...
    Modal.confirm({
      ...
      onOk: async () => {
        try {
          ...
          const isCurrentWindowProject = currentWorkspace === project.workspacePath;
  ...
  const handleOpenDirectory = async () => {
    ...
    try {
      ...
      if (hasProject) {
        ...
        const newProject = allProjects.find(p => p.workspacePath === openDirPath);
  ...
  return (
    <div style={{ padding: '24px' }}>
      ...
      {loading ? (
        ...
        >
          <Button type="primary" icon={<FolderOpenOutlined />} onClick={() => setShowOpenDirModal(true)}>
              ...
              <Card.Meta
                ...
                description={
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                    <div style={{ color: '#666', fontSize: '14px', display: '-webkit-box', WebkitLineClamp: '2', WebkitBoxOrient: 'vertical', overflow: 'hidden' }}>

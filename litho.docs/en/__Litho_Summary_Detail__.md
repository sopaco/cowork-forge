...
[
  {
    "code_dossier": {
      "code_purpose": "entry",
      "description": "Cowork Forge CLI Entry Point - AI-powered software development system command-line interface",
    ...
    "detailed_description": "This is the main entry point for the Cowork Forge CLI application, which serves as an AI-powered software development system. The component provides a comprehensive command-line interface for managing AI-assisted software projects through various workflows including project creation, resumption, modification, reversion, and status monitoring. It implements a session-based architecture that tracks project state and manages incremental changes through specialized pipelines.",
    "interfaces": [
      {
        ...
        "parameters": [
          ...
          {
            "description": "Enable LLM streaming output",
            "is_optional": true,
            "name": "stream",
            "param_type": "bool"
          }
      ...
      },
      {
        ...
        "return_type": "Result<ModelConfig>",
        "visibility": "private"
      },
      {
      ...
      {
        "description": "Revert project from specific stage",
        "interface_type": "function",
        "name": "cmd_revert",
        "parameters": [
          {
            "description": "Stage to restart from",
            "is_optional": false,
            "name": "from_stage",
            "param_type": "&str"
          },
      ...
      {
        "description": "Modify existing project with incremental changes",
        "interface_type": "function",
        "name": "cmd_modify",
        "parameters": [
          {
            "description": "Change idea/description",
            "is_optional": false,
            "name": "idea",
            "param_type": "&str"
          },
      ...
      {
        "description": "Execute pipeline with given input",
        "interface_type": "function",
      ...
      {
        "description": "Check if path should be ignored",
        "interface_type": "function",
        "name": "should_ignore_project_path",
        "parameters": [
          {
      ...
      {
        "description": "Collect file fingerprints for change detection",
        "interface_type": "function",
        "name": "collect_project_file_fingerprints",
        "parameters": [],
        "return_type": "Result<HashMap<String, (u64, u64)>>",
        "visibility": "private"
      },
      {
        "description": "Diff file fingerprints to detect changes",
        "interface_type": "function",
        "name": "diff_project_files",
        "parameters": [
          {
            "description": "Before state",
            "is_optional": false,
            "name": "before",
            "param_type": "&HashMap<String, (u64, u64)>"
          },
          {
        ...
        "return_type": "(Vec<String>, Vec<String>, Vec<String>)",
        "visibility": "private"
      }
    ],
    "responsibilities": [
      "Command-line interface parsing and routing",
      "Session management and project state tracking",
      "Pipeline orchestration and execution",
      "Configuration management",
      "Project file change detection and patching"
    ]
  },
  {
    "code_dossier": {
  ...
  },
  {
    "code_dossier": {
      "code_purpose": "config",
      "description": "Configuration file containing instruction strings for Design Actor and Design Critic components in a software architecture system",
    ...
    "dependencies": [],
    "detailed_description": "This component contains two main configuration constants that define the behavior and workflow for AI agents responsible for software architecture design. DESIGN_ACTOR_INSTRUCTION provides a comprehensive 6-step workflow for creating system architecture with human-in-the-loop (HITL) feedback, emphasizing simplicity and minimalism. DESIGN_CRITIC_INSTRUCTION defines verification rules to ensure the architecture meets strict simplicity criteria before approval. The component serves as a configuration hub for the design automation system, enforcing architectural best practices through detailed instructions and validation rules.",
    "interfaces": [],
    "responsibilities": [
      "Define AI agent instruction sets for architecture design workflow",
      "Enforce simplicity-first architectural principles through configuration",
      "Provide human-in-the-loop feedback integration points",
      "Establish validation criteria for architectural quality",
      "Maintain consistency in design methodology across the system"
    ]
  },
  {
    "code_dossier": {
  ...
  },
  {
    "code_dossier": {
      "code_purpose": "agent",
      "description": "Implementation Plan Agent instructions - Actor and Critic roles with Human-in-the-Loop (HITL) feedback mechanism",
    ...
    "dependencies": [],
    "detailed_description": "This component defines two intelligent agents (Actor and Critic) that work together to create and validate implementation plans. The Plan Actor is responsible for generating simple, core-focused implementation tasks based on design components, while the Plan Critic serves as a gatekeeper to verify task quality, simplicity, and completeness. The system implements a rigorous workflow with mandatory human review steps and clear rejection criteria for non-core tasks.",
    "interfaces": [
      {
        "description": "Detailed instruction set for Plan Actor agent defining the implementation plan creation workflow",
        "interface_type": "constant",
      ...
      {
        "description": "Detailed instruction set for Plan Critic agent defining the plan validation and quality assurance workflow",
        "interface_type": "constant",
    ...
    "responsibilities": [
      "Generate implementation task plans focused on core business logic",
      "Validate task plans against simplicity and quality criteria",
      "Manage human-in-the-loop feedback integration",
      "Enforce task creation workflow with mandatory validation steps"
    ]
  },
  {
    "code_dossier": {
      "code_purpose": "agent",
      "description": "Idea Agent instruction component for Cowork Forge system",
    ...
    "dependencies": [],
    "detailed_description": "This component implements the Idea Agent, which serves as the first step in the Cowork Forge system workflow. It provides detailed instructions for processing user project ideas through a structured workflow: understanding user input, creating structured markdown summaries, saving initial versions, facilitating user review/editing, handling review results (including mandatory saving of user edits), and finalizing the idea for PRD team processing. The agent enforces strict workflow adherence with critical rules around saving user edits to prevent data loss.",
    "interfaces": [],
    "responsibilities": [
      "Process and understand user project ideas through structured analysis",
      "Create and maintain idea.md file with standardized markdown format",
      "Facilitate user review and editing workflow with mandatory change preservation",
      "Enforce strict workflow compliance to prevent data loss during editing",
      "Serve as initial gateway for project idea processing in Cowork Forge system"
    ]
  },
  {
    "code_dossier": {
  ...
  },
  {
    "code_dossier": {
      "code_purpose": "agent",
      "description": "PRD Agent instructions defining Actor and Critic roles for Product Requirements Document creation with Human-in-the-Loop validation",
    ...
    "dependencies": [],
    "detailed_description": "This component implements a PRD (Product Requirements Document) creation system using an Actor-Critic architecture with Human-in-the-Loop (HITL) validation. The Actor role is responsible for creating requirements and features from project ideas, gathering user feedback, and saving PRD documents. The Critic role acts as a gatekeeper to verify that the Actor completed all required steps correctly and maintains simplicity by rejecting non-core requirements. The system enforces a strict simplicity-first approach, focusing only on core business functionality while explicitly rejecting performance, testing, deployment, and monitoring requirements unless explicitly requested.",
    "interfaces": [
      {
        "description": "Instruction set defining the Actor role's responsibilities and workflow",
        "interface_type": "constant",
      ...
      {
        "description": "Instruction set defining the Critic role's verification procedures",
        "interface_type": "constant",
    ...
    "responsibilities": [
      "Define PRD creation workflow with mandatory steps",
      "Enforce simplicity principle for requirement generation",
      "Provide structured instructions for Actor and Critic roles",
      "Implement Human-in-the-Loop validation process",
      "Ensure data persistence and verification mechanisms"
    ]
  },
  {
    "code_dossier": {
  ...
  },
  {
    "code_dossier": {
      "code_purpose": "tool",
      "description": "Data operation tools for creating and modifying structured data (Session-scoped)",
    ...
    "detailed_description": "This component provides a comprehensive set of tools for managing software development artifacts in a session-scoped environment. It implements data operation tools for creating and modifying structured data including requirements, features, design components, and implementation tasks. The component follows a consistent pattern where each tool is implemented as a struct implementing the async_trait::async_trait Tool interface, with standardized methods for name, description, parameters schema, and execution.",
    "interfaces": [
      {
        "description": "Standard tool interface that all data tools implement",
      ...
      {
        "description": "Tool for creating new requirements with SMART criteria",
        "interface_type": "struct",
      ...
      {
        "description": "Tool for adding features that implement requirements",
        "interface_type": "struct",
        "name": "AddFeatureTool",
        "parameters": [
          {
      ...
      {
        "description": "Tool for creating architectural design components",
        "interface_type": "struct",
      ...
      {
        "description": "Tool for creating implementation tasks",
        "interface_type": "struct",
        "name": "CreateTaskTool",
        "parameters": [
          {
      ...
      {
        "description": "Tool for updating feature status with valid transitions",
        "interface_type": "struct",
      ...
      {
        "description": "Tool for updating task status with dependency management",
        "interface_type": "struct",
      ...
      {
        "description": "Tool for modifying task properties with audit trail",
        "interface_type": "struct",
        "name": "UpdateTaskTool",
        "parameters": [
          {
      ...
      {
        "description": "Tool for deleting tasks with dependency cleanup",
        "interface_type": "struct",
        "name": "DeleteTaskTool",
        "parameters": [
          {
      ...
      {
        "description": "Tool for retrieving requirements and features",
        "interface_type": "struct",
      ...
      {
        "description": "Tool for retrieving design specifications",
        "interface_type": "struct",
        "name": "GetDesignTool",
        "parameters": [
          {
      ...
      {
        "description": "Tool for retrieving implementation plans",
        "interface_type": "struct",
        "name": "GetPlanTool",
        "parameters": [
          {
    ...
    "responsibilities": [
      "Manage software development lifecycle artifacts (requirements, features, designs, tasks)",
      "Provide CRUD operations for development data structures",
      "Enforce data validation and business rules",
      "Maintain data consistency across related entities",
      "Provide audit trail and feedback mechanisms"
    ]
  },
  {
    "code_dossier": {
  ...
  },
  {
    "code_dossier": {
      "code_purpose": "tool",
      "description": "Session-scoped control tools providing user interaction and feedback mechanisms",
    ...
    "detailed_description": "This component implements three essential control tools for an AI agent system: 1) ProvideFeedbackTool - records structured feedback for the Actor agent, 2) RequestReplanningTool - handles replanning requests when fundamental issues are discovered during implementation, and 3) AskUserTool - provides CLI-based user interaction capabilities. The tools are session-scoped and implement the Tool trait with proper async execution, parameter validation, and error handling.",
    "interfaces": [
      {
        "description": "Tool for providing structured feedback to the Actor agent",
        "interface_type": "struct",
      ...
      {
        "description": "Tool for requesting replanning when fundamental issues are discovered",
        "interface_type": "struct",
      ...
      {
        "description": "Tool for user interaction via CLI interface",
        "interface_type": "struct",
        "name": "AskUserTool",
        "parameters": [],
        "return_type": null,
      ...
      {
        "description": "Returns the JSON schema for tool parameters",
        "interface_type": "method",
        "name": "parameters_schema",
        "parameters": [
          {
    ...
    "responsibilities": [
      "Session-scoped tool lifecycle management and execution",
      "Structured feedback recording and categorization with severity levels",
      "Replanning request handling for architectural and design issues",
      "User interaction via CLI interface (yes/no and text input)",
      "Error handling and validation of tool parameters"
    ]
  },
  {
    "code_dossier": {
  ...
  },
  {
    "code_dossier": {
      ...
      "description": "Storage layer for .cowork/ directory - Session-scoped architecture providing file system persistence for project metadata, session artifacts, and development state",
    ...
    "detailed_description": "This component serves as the database layer for a collaborative development system (cowork), managing file-based persistence for project metadata, session artifacts, and development lifecycle state. It implements a hierarchical directory structure (.cowork/sessions/<id>/) with separate subdirectories for artifacts, state, patch data, and logs. The module provides comprehensive CRUD operations for various development artifacts including requirements, design specs, implementation plans, code metadata, feedback history, and session metadata. It supports session inheritance through base session copying and implements automatic feature status updates based on task completion.",
    "interfaces": [
      {
        "description": "Creates and returns path to session-specific directory with subdirectories",
        "interface_type": "function",
      ...
      {
        "description": "Saves requirements to session state directory",
        "interface_type": "function",
        ...
        "parameters": [
          ...
          {
            "description": "Requirements data structure to persist",
            "is_optional": false,
            "name": "requirements",
      ...
      {
        "description": "Copies state and artifacts from base session to enable session inheritance",
        "interface_type": "function",
        ...
        "parameters": [
          ...
          {
            "description": "Base session to copy from",
            "is_optional": false,
            "name": "base_session_id",
            "param_type": "&str"
          }
    ...
    "responsibilities": [
      "Directory structure management and file system operations for .cowork workspace",
      "Session-scoped data persistence for development lifecycle artifacts",
      "Project metadata management and session lifecycle tracking",
      "State synchronization and feature status automation",
      "Session inheritance and bootstrap functionality"
    ]
  },
  {
    "code_dossier": {

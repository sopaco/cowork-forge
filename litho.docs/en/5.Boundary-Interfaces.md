...
**Description**: AI-powered software development system V2 command-line interface
...
```bash
cowork-v2 new "Create a web-based task management application"
```
...
```bash
cowork-v2 --config custom.toml new "Project idea"
```

```bash
cowork-v2 --stream --verbose new "Project with real-time AI output"
```
